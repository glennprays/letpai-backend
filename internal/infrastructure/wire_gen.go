...
func InitializeApp() (*App, error) {
	...
	getSessionDetailUseCase := session.NewGetSessionDetailUseCase(sessionRepository, participantRepository, billItemRepository, notificationLogRepository, sessionBankAccountRepository)
	...
	getPaymentPageUseCase := payment.NewGetPaymentPageUseCase(participantRepository, sessionRepository, billItemRepository, contactRepository, sessionBankAccountRepository)
